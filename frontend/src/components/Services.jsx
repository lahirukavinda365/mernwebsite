            ...
            <div className="container my-5 py-5">
                <div className="row">
                        ...
                        <div className="col-md-4">
                            <div className="card p-3">
                                <div className="card-body text-center">
                                    <i className='fa fa-cogs fa-4x text-primary'></i>
                    ...
                    <div className="col-md-4">
                            <div className="card p-3">
                                <div className="card-body text-center">
                                    <i className='fa fa-laptop fa-4x text-primary'></i>
                        ...
                        <div className="col-md-4">
                            <div className="card p-3">
                                <div className="card-body text-center">
                                    <i className='fa fa-code fa-4x text-primary'></i>
                                    <h5 className="card-title mb-3 fs-4 fw-bold">Unique Design</h5>
                                    <p className="card-text lead">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                        ...
                        <div className="col-md-4">
                            <div className="card p-3">
                                <div className="card-body text-center">
                                    <i className='fa fa-star-half fa-4x text-primary'></i>
